...
func init() {
	ignore := []string{
		...
		"/tmp/0FBD3D89-4D56-4934-8AD1-0948CF164AFC /tmp/150E4412-4745-4C7E-874B-533D59802EAF /tmp/49702635-F70B-4F3D-9BFF-5583DC96286D_IN /tmp/49702635-F70B-4F3D-9BFF-5583DC96286D_OUT /tmp/4B43EF4A-4A47-4F2B-92F2-2DDC3A84C60D /tmp/A52BCA2C-9ACE-4489-B2B6-00AC6036CC95 /tmp/AlTest1.err /tmp/AlTest1.out /tmp/BCA648AF-6DCB-4CD3-9DE8-DA4C0ACE3B61 /tmp/ExmanProcessMutex /tmp/F7C71944B49B446081C0603DE90E4855_IN /tmp/F7C71944B49B446081C0603DE90E4855_OUT /tmp/KSOutOfProcessFetcher.501.ppfIhqX0vjaTSb8AJYobDV7Cu68= /tmp/VSCode Crashes /tmp/adobegc.log /tmp/boost_interprocess /tmp/com.adobe.AdobeIPCBroker.ctrl-Ciel /tmp/com.apple.launchd.JdarzGCUtK /tmp/com.apple.launchd.S31obbAD4c /tmp/ct.shutdown /tmp/swtag.log /tmp/unity-monodevelop-monoframework-4.0.5 /tmp/wifi-56WvIT.log /tmp/wifi-NrOP8F.log",
		"/configuration.php",
		"/index.php",
		"/joomla.xml",
		"/*.txt",
	...
	template.SetTemplate("GitHub/Joomla", strings.Join(ignore, "\n"))
}
